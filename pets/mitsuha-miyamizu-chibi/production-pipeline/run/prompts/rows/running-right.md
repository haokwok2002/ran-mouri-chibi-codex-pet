Create one horizontal animation strip for Codex pet `mitsuha-miyamizu-chibi`, state `running-right`.
...
State action: a light, determined eight-beat schoolgirl run toward screen-right. It is a complete alternating gait, not a whole-body slide.
...
- Frame sequence: right-facing leading-foot contact; gentle compression; rear foot passes under the body; lifted stride; opposite-foot contact; gentle compression; other foot passes; lifted stride returning smoothly to Frame 1.
- Keep the head and face stable in size. Let the torso lean only slightly toward screen-right; let the side ponytail, red cord/tassel, bow tails, and skirt trail a little toward screen-left as natural secondary motion.
